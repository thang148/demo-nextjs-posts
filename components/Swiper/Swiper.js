...
const MySwiper = memo(({ name, events, isLive, id }) => {
  ...
  function getTranslateX() {
    if (step > 1 && __slider.current && (step + 1) * slidesPerView > events.length) {
